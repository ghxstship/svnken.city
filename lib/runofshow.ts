...
export const RUN_OF_SHOW: RunBlock[] = [
  ...
  { t: "T+47", block: "The Feature", min: "6 min", zone: "The Abyss", depth: "4,000 – 6,000 m", beat: "The voyage bottoms out and the city first rises on the horizon. The room's biggest spike.", feature: true },
...
// The five depth zones, for the voyage overview.
